...
function geocodeLatLng(lat, lng) {
    ...
    .then(response => response.json())
    .then(data => {
        let country = data.results[0].address_components[6].long_name ? data.results[0].address_components[6].long_name : "N/A" 
        let state = data.results[0].address_components[5].long_name ? data.results[0].address_components[5].long_name : "N/A" 
        let city = data.results[0].address_components[4].long_name ? data.results[0].address_components[4].long_name : "N/A" 
